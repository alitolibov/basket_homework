  ...
  place.innerHTML = `
        <nav class="top-nav" >
            ...
            <div class="header_navigation_links">
                <a href="#">Все акции</a>
                <a href="#">Черная пятница</a>
                <a href="#">Телевизоры</a>
                <a href="#">iPhone 14 b 14 pro</a>
                <a href="#">Ноутбуки</a>
                <a href="#">Экспресс-доставка</a>
                <a href="#">Гарантия лучшей цены</a>
...
let first_arr = [
  ...
  "Частые вопросы",
  "Акции и скидки",
  "M.Club – кэшбек и Бонусные рубли",
  "Доставка",
  "Обмен и возврат",
  "М.Сервис – ремонт, страховка",
  "Кредит и рассрочка",
  "Заберите товар через 15 минут после заказа",
  "Гарантия лучшей цены",
  "Публичная оферта",
  "Безопасность в Интернете",
];
let second_arr = [
  "Техника для вашей компании",
  "Тендеры",
  "Поставщикам",
  "Арендуем помещения под магазины",
...
let fourth_arr = [
  ...
  "Как сделать, чтобы вещи в шкафу приятно пахли",
  "Когда будет Черная пятница в 2022 году",
  "Тестируем iPhone 14 Pro Max: эволюция с элементами революции",
  "Слушают ли нас гаджеты: комментарии эксперта",
  "Топ-12 товаров со скидками: что купить на Черной пятнице",
  "Классическая шарлотка с яблоками: пошаговый рецепт от профессионального повара",
  "Чем iPhone 14 отличается от iPhone 13? Сравниваем обычные и Pro-версии",
